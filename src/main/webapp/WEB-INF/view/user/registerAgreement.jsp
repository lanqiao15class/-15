...
<html>
    ...
    <body>
		...
		<div class="main">
			<div class="top bold">注册协议</div>
			<div class="xy-content">
				<p class="title">一、总则</p>
				<p>1.1 全国大学生信息安全竞赛网的所有权和运营权归教育部信息安全类教学指导委员会所有。 </p>
				<p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与全国大学生信息安全竞赛网之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。 </p>
				<p>1.3 本协议则可由全国大学生信息安全竞赛网随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。</p>
				<p class="title">二、服务内容</p>
				<p>2.1 全国大学生信息安全竞赛网的具体内容由本站根据实际情况提供。 </p>
				<p>2.2 本站仅提供竞赛相关的网络服务，除此之外与竞赛相关的设备及所需的费用均应由用户自行负担。</p>
				<p class="title">三、用户帐号</p>
				<p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。全国大学生信息安全竞赛网有权对会员的权限设计进行变更。</p>
				<p>3.2 用户只能按照注册要求提供邮箱等信息注册。用户有义务保证密码和帐号的安全，用户利用该密码和帐号所进行的一切活动引起的任何损失或损害，由用户自行承担全部责任，本站不承担任何责任。如用户发现帐号遭到未授权的使用或发生其他任何安全问题，应立即修改帐号密码并妥善保管，如有必要，请通知本站。因黑客行为或用户的保管疏忽导致帐号非法使用，本站不承担任何责任。</p>
				...
				<p>六、版权声明</p>
				<p>6.1 本站的文字、图片、音频、视频等版权均归教育部信息安全类教学指导委员会享有或与作者共同享有，未经本站许可，不得任意转载。 </p>
				<p>6.2 本站特有的标识、版面设计、编排方式等版权均属教育部信息安全类教学指导委员会享有，未经本站许可，不得任意复制或转载。 </p>
				<p>6.3 使用本站的任何内容均应注明“来源于全国大学生信息安全竞赛网”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
				...
				<p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，全国大学生信息安全竞赛网对此不承担任何责任。</p>
				...
				<p>8.3 本协议解释权及修订权归深圳教育部信息安全类教学指导委员会所有。</p>
			</div>
		</div><!--注册协议-->
    </body>
</html>
