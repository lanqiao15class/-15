...
<div class="content-inner-part">
   	<div class="inner-reletive">
		...
		<div class="tit-h1-box">
             <h1 class="tit-first">
                 <span>学员管理</span><i class="gt-icon">&gt;</i><span class="curr">异常状态学员管理</span>
             </h1>
       </div>
  		<!--右侧标题部分结束-->
	   <!--右侧内容部分背景白色开始-->
	  <div class="inner-white">
	      <div class="tit-h2 clearfix">
	          ...
	          <c:when test="${opType eq 100 }">
	          	   <c:if  test="${lq:ifIn(myFunction,'58')}">
	                ...
	                <c:if test="${lq:ifIn(myFunction,'59')}">
	                    <c:if test="${not empty default_opType }">
	                 ...
	                 <c:if test="${lq:ifIn(myFunction,'60')}">
	                 	 <c:if test="${not empty default_opType }">
	      ...
	      <div class="search-part-tall">
	          <div class="query-opt-coopration clearfix">
	              ...
	              <div class="opt-btn-box">
	    	          ...
	    	          <!-- 学员导出信息表单开始 -->
	                  <form action="${ctxBase}/report/stuUnnormalExport.do" target="_blank" style="display:none" method="post" id="exporStuForm">
	                  </form>
	                  <!-- 学员导出信息表单结束 -->
	              </div>
	          </div>
  ...
  <!--右侧内容部分结束-->
   ...
   <jsp:include page="/WEB-INF/view/include/pagejavascript.jsp">
	<jsp:param name="funcName" value="UNNORMALSTULIST.dopagechange" />
	</jsp:include>
	<!-- 引入分页结束 -->
