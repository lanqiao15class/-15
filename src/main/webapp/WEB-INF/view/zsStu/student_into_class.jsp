...
<!-- 				<button id="test">测试</button> -->
				<i class="gt-icon">&gt;</i><span id="span1"></span>
				<i class="gt-icon">&gt;</i><span class="curr" id="span2"></span>
			</h1>
		</div>
		<!--右侧标题部分结束-->
		<!--右侧内容白色开始-->
			...
			<div class="inner-divide-rel">
				...
				<div class="class-infomation">
					...
					<div class="class-info-in">
						<div class="class-scroll-part">
							...
							<div class="clearfix class-info-row">
								<label class="label-about-class">拟校园结课日期：</label><span class="intro-class-part info" id="schoolTime1"> </span>
							</div>
				...
				<div class="divide-student">
					<div class="divide-student-rel">
						<div class="table-divide-box" id="myGridclass"></div>
					</div>
				</div>
				<!--转班学员列表结束-->
				<div class="bottom-btn-box">
					<a href="javascript:void(0)" class="c-blue mr10" id="returnStudentList">返回重新选择学员</a>
					<button class="btn btn-blue" type="button" id="intoClassSubmitBtn"><span id="stuIntoClassTips">确认分班</span></button>
<!-- 					<button class="btn btn-blue" type="button" onclick="CHECK_STUDENT_INFO.deleteStu('12')">确认分班</button> -->
				</div>
			</div>
		</div>
		<!--班级分班部分结束-->
