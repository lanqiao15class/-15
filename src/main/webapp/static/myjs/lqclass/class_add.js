...
//获取上下文路径
CLASS_ADD.basePath = basePath;

//初始化加载
/**=====================================init=============================================== */
CLASS_ADD.init = function(){
...
/**==========================================表单验证开始========================================== */
CLASS_ADD.submitClassAdd = function(){
...
//			cepTeacherId : "请选择cep老师",
		...
		submitHandler : function(form) {
			var myData = $("#pageClassAddForm").serialize();
			$.ajax({
				type : "post",
...
/**========================================  获取对应的二级类型开始========================================== */
CLASS_ADD.showClassTypeReal = function(){
...
CLASS_ADD.refleshPage = function(){
	$.ajax({
        type:"post",
        url:basePath+"/lqClass/toAddClassPage.do",
        data:{},
        dataType:"html",
