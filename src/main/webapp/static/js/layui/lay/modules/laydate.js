...
/*
 * modified:   apps/themes/default/templates/admin/js/layui/lay/modules/laydate.js
 * 修复时间插件的位置bug：
 * 1.更改了#laydate_box的position.top的策略，改为只在元素下方插入;(line175)
 * 2.更改了#laydate_box的插入位置：由body转为.content-wrap;(line200)
*/
layui.define(function(e) {
    ...
    t.laydate = function(e) {
        ...
        e.style.top = $(n.elem).offset().top+$(".content-wrapper").scrollTop() + $(n.elem).height() + "px";
    }, n.follow = function(e) {
