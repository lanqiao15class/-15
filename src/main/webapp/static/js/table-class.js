...
function actionRender(row, cell, value, columnDef, dataContext) {
	var s= "",
		...
		icon_stu_list='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="班级学员列表" onclick="classOfStudent();"><i class="opti-icon Hui-iconfont">&#xe611;</i></a>',
		icon_look_class='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="查看" onclick="classInfoDialogue()"><i class="opti-icon Hui-iconfont">&#xe725;</i></a>',
		icon_edit_class='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="编辑" onclick="setClassStatusDialogue();"><i class="opti-icon Hui-iconfont">&#xe6e3;</i></a>',
		icon_optset_class='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="创建班级记录" onclick="createClassRecord()"><i class="opti-icon Hui-iconfont">&#xe70c;</i></a>',
		icon_end='</div>';
		//根据行数据确定是否显示icon2.png
		if(dataContext.nstatus==1)
		s += icon_start+icon_stu_list+icon_look_class+icon_edit_class+icon_optset_class+icon_end;
		return s;
}
