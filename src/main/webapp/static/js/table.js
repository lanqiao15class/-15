...
function actionRender(row, cell, value, columnDef, dataContext) {
	var s= "",
		...
		icon_audit='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="审核" onclick="auditStuDialogue();"><i class="opti-icon Hui-iconfont">&#xe692;</i></a>',
		icon_edit='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="编辑" onclick="stuInfoDialogue();"><i class="opti-icon Hui-iconfont">&#xe6df;</i></a>',
		icon_look='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="查看" onclick="stuInfoDialogue()"><i class="opti-icon Hui-iconfont">&#xe725;</i></a>',
		icon_del='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="删除"><i class="opti-icon Hui-iconfont">&#xe609;</i></a>',
		icon_optset='<a class="c-blue opt-incon-btn" href="javascript:void(0);" title="设置学员状态" onclick="setStuStatusDialogue()"><i class="opti-icon Hui-iconfont">&#xe637;</i></a>',
		icon_end='</div>';
		//根据行数据确定是否显示icon2.png
		if(dataContext.nstatus==1)
		s += icon_start+icon_audit+icon_edit+icon_look+icon_del+icon_optset+icon_end;
		return s;
}
