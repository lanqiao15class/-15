...
[
    ...
    {
        "hex": "#C5E384",
        "label": "汪艺Yellow Green",
        "rgb": "(197, 227, 132)"
    },
    {
        "hex": "#FFAE42",
        "label": "王雷艳Yellow Orange ",
        "rgb": "(255, 174, 66)"
    }
];

$(function () {
  $('#stuname').autocompleter({
        ...
        // custom template
        template: '{{ label }}',//'{{ label }} <span>({{ hex }})</span>',
        ...
        callback: function (value, index, selected) {
            if (selected) {
				 $('#stuname').val(selected.label)
            }
        }
    });
	
	$('#stuprofession').autocompleter({
        // marker for autocomplete matches
        highlightMatches: true,
        ...
        callback: function (value, index, selected) {
            if (selected) {
				 $('#stuprofession').val(selected.label)
            }
        }
    });
	
	$('#stucollege').autocompleter({
        // marker for autocomplete matches
        highlightMatches: true,
